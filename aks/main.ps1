...
$VnetName                    = "vnet-spokeName1-$Env-$Location-001"
# RG where target vnet is 
$RgSpokeName2Name                      = "rg-spokeName1-$Env-$Location-001"
# subnet name for aks
...
Write-Host " Virtual Network RG =       $RgSpokeName2Name" 
...
## Creating subnet ### 
$subnet = CreateAKSSubnet $VnetName $AKSSubnetName $RgSpokeName2Name $SubnetSpokeName2AKSPrefix
$myid = $kv.ResourceId
Write-Host " ****** $myid ******" 
...
$subnet = "/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.Network/virtualNetworks/{2}/subnets/{3}" -f  $AZURE_SUBSCRIPTION_ID_SPOKE, $RgSpokeName2Name, $VnetName, $AKSSubnetName 
