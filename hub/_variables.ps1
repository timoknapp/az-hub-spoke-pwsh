...
$VnetHubIpPrefix                = '20.13.252.0/24'
$SubnetErGatewayPrefix          = '20.13.252.64/27'
$SubnetFirewallPrefix           = '20.13.252.0/26'
$SubnetDnsPrInboundPrefix       = '20.13.252.96/28'
$SubnetDnsPrOutboundPrefix      = '20.13.252.128/28'
$SubnetPrivateLinkPrefix        = '20.13.252.144/28'
